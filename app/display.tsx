...
export default function CorrectedSuspensionScene({ vecs }: Props) {
    ...
    useEffect(() => {
        if (!mountRef.current || !vecs || vecs.length < 9) return;
    ...
    return (
        <div className="relative max-w-[60vw] h-175 bg-slate-950 rounded-2xl overflow-hidden border border-slate-800 shadow-2xl">
